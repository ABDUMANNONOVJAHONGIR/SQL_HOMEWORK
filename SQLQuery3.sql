--create table employees (employee_id int identity(100,1),
...
--select * from employees
--insert into employees values
--('Neena', 'Kochhar', 'KOCHHAR', '515.123.4568', '2005-09-21', 'AD_VP', 17000.00, 0.00, 100, 90)
--select * from employees
--insert into employees values
...
--('Nancy     ', 'Greenberg ', 'NGREENBE', '515.124.4569       ', '2002-08-17', 'FI_MGR    ', 12008.00 , 0.00 , 101 ,00 ),
--('Daniel    ', 'Faviet    ', 'DFAVIET ', '515.124.4169       ', '2002-08-16', 'FI_ACCOUNT',  9000.00 , 0.00 , 108 ,00 ),
--('John      ', 'Chen      ', 'JCHEN   ', '515.124.4269       ', '2005-09-28', 'FI_ACCOUNT',  8200.00 , 0.00 , 108 ,00 ),
--('Ismael    ', 'Sciarra   ', 'ISCIARRA', '515.124.4369       ', '2005-09-30', 'FI_ACCOUNT',  7700.00 , 0.00 , 108 ,00 ),
--('Jose Manue', 'Urman     ', 'JMURMAN ', '515.124.4469       ', '2006-03-07', 'FI_ACCOUNT',  7800.00 , 0.00 , 108 ,00 ),
--('Luis      ', 'Popp      ', 'LPOPP   ', '515.124.4567       ', '2007-12-07', 'FI_ACCOUNT',  6900.00 , 0.00 , 108 ,00 ),
...
--('Irene     ', 'Mikkilinen', 'IMIKKILI', '650.124.1224       ', '2006-09-28', 'ST_CLERK  ',  2700.00 , 0.00 , 120 ,50 ),
...
--('Christophe', 'Olsen     ', 'COLSEN  ', '011.44.1344.498718 ', '2006-03-30', 'SA_REP    ',  8000.00 , 0.20 , 145 ,80 ),
...
--('Shelley   ', 'Higgins   ', 'SHIGGINS', '515.123.8080       ', '2002-06-07', 'AC_MGR    ', 12008.00 , 0.00 , 101 ,10 ),
--('William   ', 'Gietz     ', 'WGIETZ  ', '515.123.8181       ', '2002-06-07', 'AC_ACCOUNT',  8300.00 , 0.00 , 205 ,10 )
--select * from employees 
